...
library CoreLibrary { 
    ...
    * @param _decimals of underlying asset 
    **/
    function init(
        ReserveData storage _self,
    ...
    **/
    function getCompoundedBorrowBalance(
        ...
        Console.log(_self.stableBorrowRate);
        ...
        if (_self.stableBorrowRate > 0) {
            ...
            Console.log(_reserve.lastVariableBorrowCumulativeIndex);
            Console.log(_self.lastVariableBorrowCumulativeIndex);
            //variable interest
            cumulatedInterest = calculateCompoundedInterest(
                _reserve
    ...
    **/
    function increaseTotalBorrowsStableAndUpdateAverageRate(
        ...
        _reserve.currentAverageStableBorrowRate = (weightedLastBorrow + weightedPreviousTotalBorrows)
