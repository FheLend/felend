...
contract LendingPoolCore is VersionedInitializable {
    ...
    * @param _encryptedAmount the amount being deposited
    ...
    **/
    ...
    ) external { // todo: restrict here
        reserves[_reserve].updateCumulativeIndexes();
        uint256 _amount = FHE.decrypt(_encryptedAmount);
    ...
    **/
    ...
    // onlyLendingPool 
    returns (CoreLibrary.InterestRateMode, uint256) {
    ...
    **/
    function setUserUseReserveAsCollateral(address _reserve, address _user, bool _useAsCollateral)
        public
        // onlyLendingPool TODO: update this
    {
    ...
    **/
    fallback() external payable {
        ...
        require(_isContract(msg.sender), "Only contracts can send ether to the Lending pool core");
    }
    // 
    ...
    * @param _user the address of the user from where the transfer is happening
    * @param _encryptedAmount the amount being transferred
    **/
    function transferToReserve(address _reserve, address payable _user, euint128 _encryptedAmount)
        external
        payable
        // onlyLendingPool TODO: update this
    {
    ...
    * @param _underlyingDecimals decimals of underlying asset 
    **/
    function initReserve(
        ...
        reserves[_reserve].init(_aTokenAddress, _interestRateStrategyAddress, _underlyingDecimals);
    ...
    **/
    ...
    function updateUserStateOnBorrowInternal(
        ...
        user.principalBorrowBalance = user.principalBorrowBalance + _amountBorrowed + _balanceIncrease;
    ...
    **/
    function updateUserStateOnLiquidationInternal(
        ...
        if(_feeLiquidated > 0){
            user.originationFee = user.originationFee - _feeLiquidated;
        }
